...
- Upload files lib/codex_pad.pyand lib/codex_pad_c10.pyto the root directory of your device
...
- *Important: Modify MAC address configuration*
    ...
    codex_pad.connect("E4:66:E5:A2:24:5D") # Replace with your gamepad's MAC address
    ```
...
- **Location**: [examples/codex_pad_c10_basic_polling/main.py](examples/codex_pad_c10_basic_polling/main.py)
...
- **Location**: [examples/codex_pad_c10_state_detection/main.py](examples/codex_pad_c10_state_detection/main.py)
