...
while True:
    ...
    if not log_time or log_time + 30 < time.ticks_ms():
        ...
        print(
            ...
            f"Square(X):{int(codex_pad_obj.button_state(codex_pad.BUTTON_SQUARE_X))},",
            f"Triangle(Y):{int(codex_pad_obj.button_state(codex_pad.BUTTON_TRIANGLE_Y))},",
            f"Cross(A):{int(codex_pad_obj.button_state(codex_pad.BUTTON_CROSS_A))},",
            f"Circle(B):{int(codex_pad_obj.button_state(codex_pad.BUTTON_CIRCLE_B))},",
